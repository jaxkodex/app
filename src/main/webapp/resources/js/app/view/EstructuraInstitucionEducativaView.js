...
define(['backbone', 
        ...
        'collection/GradoCollection',
        'collection/SeccionCollection',
        'AdminApplication'], function (Backbone,
        		NivelCollection,
        		GradoCollection,
        		SeccionCollection,
        		app) {
	app.meta.views.EstructuraInstitucionEducativaView = Backbone.View.extend({
	...
	return app.meta.views.EstructuraInstitucionEducativaView;
});
