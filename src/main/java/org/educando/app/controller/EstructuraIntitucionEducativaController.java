...
public class EstructuraIntitucionEducativaController {
	...
	@RequestMapping(value="/api/admin/estructuraie/nivel", method=RequestMethod.GET)
	public @ResponseBody List<Nivel> indexNivel () {
		return nivelService.listAll();
	}
	
	@RequestMapping(value="/api/admin/estructuraie/nivel", method=RequestMethod.POST)
	public @ResponseBody Nivel create (@RequestBody Nivel nivel) {
		return nivelService.create(nivel);
	}
	
	@RequestMapping(value="/api/admin/estructuraie/nivel/{idNivel}", method=RequestMethod.PUT)
	public @ResponseBody Nivel update (@RequestBody Nivel nivel, @PathVariable Integer idNivel) {
		return nivelService.update(nivel);
	}
	
	@RequestMapping(value="/api/admin/estructuraie/nivel/{idNivel}", method=RequestMethod.DELETE)
	...
	@RequestMapping(value="/api/admin/estructuraie/grado", method=RequestMethod.GET)
	...
	@RequestMapping(value="/api/admin/estructuraie/grado", method=RequestMethod.POST)
	public @ResponseBody Grado createGrado (@RequestBody Grado grado) {
		return gradoService.create(grado);
	}
	
	@RequestMapping(value="/api/admin/estructuraie/grado/{idGrado}", method=RequestMethod.PUT)
	...
	@RequestMapping(value="/api/admin/estructuraie/grado/{idGrado}", method=RequestMethod.DELETE)
	...
	@RequestMapping(value="/api/admin/estructuraie/seccion", method=RequestMethod.GET)
	...
	@RequestMapping(value="/api/admin/estructuraie/seccion", method=RequestMethod.POST)
	public @ResponseBody Seccion createSeccion (@RequestBody Seccion seccion) {
		return seccionService.create(seccion);
	}
	
	@RequestMapping(value="/api/admin/estructuraie/seccion/{idSeccion}", method=RequestMethod.PUT)
	...
	@RequestMapping(value="/api/admin/estructuraie/seccion/{idSeccion}", method=RequestMethod.DELETE)
